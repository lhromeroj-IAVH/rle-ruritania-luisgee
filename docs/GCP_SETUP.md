...
- Access to the GCP project (e.g., `rle-ruritania-luisgee`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-luisgee" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-luisgee.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-luisgee --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-luisgee.iam.gserviceaccount.com" \
  --project="rle-ruritania-luisgee" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-luisgee.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-luisgee.
